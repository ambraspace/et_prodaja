...
public class DeliveryNoGenerator implements IdentifierGenerator
{

	private static final long serialVersionUID = 1L;

	private final DeliveryNoSequence sequence;

	public DeliveryNoGenerator	(DeliveryNoSequence config,
	...
	public Serializable generate(SharedSessionContractImplementor session, Object obj)
	{
		...
		String prefix = String.format("I-%d-", LocalDate.now().getYear());
